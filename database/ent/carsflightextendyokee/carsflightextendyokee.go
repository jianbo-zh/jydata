...
const (
	// Label holds the string label denoting the carsflightextendyokee type in the database.
	Label = "cars_flight_extend_yokee"
	...
	// Table holds the table name of the carsflightextendyokee in the database.
	Table = "cars_flight_extend_yokees"
)

// Columns holds all SQL columns for carsflightextendyokee fields.
var Columns = []string{
	FieldID,
	FieldFlightID,
...
// OrderOption defines the ordering options for the CarsFlightExtendYokee queries.
