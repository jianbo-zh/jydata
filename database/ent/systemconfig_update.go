...
func (scu *SystemConfigUpdate) SetGroup(s systemconfig.Group) *SystemConfigUpdate {
	scu.mutation.SetGroup(s)
	return scu
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (scu *SystemConfigUpdate) SetNillableGroup(s *systemconfig.Group) *SystemConfigUpdate {
	if s != nil {
		scu.SetGroup(*s)
	}
	return scu
...
func (scu *SystemConfigUpdate) SetUpdateTime(t time.Time) *SystemConfigUpdate {
...
func (scu *SystemConfigUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := scu.mutation.Group(); ok {
...
// SetGroup sets the "group" field.
func (scuo *SystemConfigUpdateOne) SetGroup(s systemconfig.Group) *SystemConfigUpdateOne {
	scuo.mutation.SetGroup(s)
	return scuo
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (scuo *SystemConfigUpdateOne) SetNillableGroup(s *systemconfig.Group) *SystemConfigUpdateOne {
	if s != nil {
		scuo.SetGroup(*s)
	}
	return scuo
...
// SetUpdateTime sets the "update_time" field.
func (scuo *SystemConfigUpdateOne) SetUpdateTime(t time.Time) *SystemConfigUpdateOne {
...
func (scuo *SystemConfigUpdateOne) check() error {
	if v, ok := scuo.mutation.Group(); ok {
		if err := systemconfig.GroupValidator(v); err != nil {
			return &ValidationError{Name: "group", err: fmt.Errorf(`ent: validator failed for field "SystemConfig.group": %w`, err)}
		}
	}
...
func (scuo *SystemConfigUpdateOne) sqlSave(ctx context.Context) (_node *SystemConfig, err error) {
	...
	if value, ok := scuo.mutation.Group(); ok {
		_spec.SetField(systemconfig.FieldGroup, field.TypeEnum, value)
	}
