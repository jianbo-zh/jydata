...
const (
	// Label holds the string label denoting the otaversion type in the database.
	Label = "ota_version"
	...
	// Table holds the table name of the otaversion in the database.
	Table = "ota_versions"
)

// Columns holds all SQL columns for otaversion fields.
var Columns = []string{
	FieldID,
	FieldDeleteTime,
	FieldScenicAreaID,
...
// OrderOption defines the ordering options for the OtaVersion queries.
