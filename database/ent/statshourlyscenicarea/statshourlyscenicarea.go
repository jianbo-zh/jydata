...
const (
	// Label holds the string label denoting the statshourlyscenicarea type in the database.
	Label = "stats_hourly_scenic_area"
	...
	// Table holds the table name of the statshourlyscenicarea in the database.
	Table = "stats_hourly_scenic_areas"
)

// Columns holds all SQL columns for statshourlyscenicarea fields.
var Columns = []string{
	FieldID,
	FieldScenicAreaID,
	FieldY,
...
var (
	...
	DefaultCarAlarmTimes uint32
	// DefaultCreateTime holds the default value on creation for the "create_time" field.
	DefaultCreateTime func() time.Time
)

// OrderOption defines the ordering options for the StatsHourlyScenicArea queries.
