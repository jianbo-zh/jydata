...
func (ru *RoleUpdate) SetAccessIds(i []int) *RoleUpdate {
	ru.mutation.SetAccessIds(i)
	return ru
}

// AppendAccessIds appends i to the "access_ids" field.
func (ru *RoleUpdate) AppendAccessIds(i []int) *RoleUpdate {
	ru.mutation.AppendAccessIds(i)
	return ru
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.AccessIds(); ok {
		_spec.SetField(role.FieldAccessIds, field.TypeJSON, value)
	}
	if value, ok := ru.mutation.AppendedAccessIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, role.FieldAccessIds, value)
		})
	}
...
// SetAccessIds sets the "access_ids" field.
func (ruo *RoleUpdateOne) SetAccessIds(i []int) *RoleUpdateOne {
	ruo.mutation.SetAccessIds(i)
	return ruo
}

// AppendAccessIds appends i to the "access_ids" field.
func (ruo *RoleUpdateOne) AppendAccessIds(i []int) *RoleUpdateOne {
	ruo.mutation.AppendAccessIds(i)
	return ruo
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if value, ok := ruo.mutation.AccessIds(); ok {
		_spec.SetField(role.FieldAccessIds, field.TypeJSON, value)
	}
	if value, ok := ruo.mutation.AppendedAccessIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, role.FieldAccessIds, value)
		})
	}
