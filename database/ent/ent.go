...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			activityorder.Table:          activityorder.ValidColumn,
			apppush.Table:                apppush.ValidColumn,
			appversion.Table:             appversion.ValidColumn,
			billingstrategy.Table:        billingstrategy.ValidColumn,
			car.Table:                    car.ValidColumn,
			caralarm.Table:               caralarm.ValidColumn,
			carconfig.Table:              carconfig.ValidColumn,
			carconfigdownload.Table:      carconfigdownload.ValidColumn,
			carconfigpack.Table:          carconfigpack.ValidColumn,
			carconfigstatus.Table:        carconfigstatus.ValidColumn,
			carcumulative.Table:          carcumulative.ValidColumn,
			carextendyokee.Table:         carextendyokee.ValidColumn,
			carlogupload.Table:           carlogupload.ValidColumn,
			carsflight.Table:             carsflight.ValidColumn,
			carsflightextendyokee.Table:  carsflightextendyokee.ValidColumn,
			carsmodels.Table:             carsmodels.ValidColumn,
			carsmodelsgroups.Table:       carsmodelsgroups.ValidColumn,
			carsmodelsgroupsparams.Table: carsmodelsgroupsparams.ValidColumn,
			carsoperatelog.Table:         carsoperatelog.ValidColumn,
			coupon.Table:                 coupon.ValidColumn,
			feedback.Table:               feedback.ValidColumn,
			file.Table:                   file.ValidColumn,
			mapversion.Table:             mapversion.ValidColumn,
			operationuser.Table:          operationuser.ValidColumn,
			order.Table:                  order.ValidColumn,
			orderappeal.Table:            orderappeal.ValidColumn,
			orderbilling.Table:           orderbilling.ValidColumn,
			...
			poiextendyokee.Table:         poiextendyokee.ValidColumn,
			profitreceiver.Table:         profitreceiver.ValidColumn,
			role.Table:                   role.ValidColumn,
			route.Table:                  route.ValidColumn,
			scenicarea.Table:             scenicarea.ValidColumn,
			scenicareaextendyokee.Table:  scenicareaextendyokee.ValidColumn,
			...
			statshourlycar.Table:         statshourlycar.ValidColumn,
			statshourlyscenicarea.Table:  statshourlyscenicarea.ValidColumn,
