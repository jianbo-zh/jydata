...
func (slq *SystemLogQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (slq *SystemLogQuery) FirstIDX(ctx context.Context) uint64 {
...
func (slq *SystemLogQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (slq *SystemLogQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (slq *SystemLogQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (slq *SystemLogQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := slq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(systemlog.FieldTimestamp).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SystemLog.Query().
//		Select(systemlog.FieldTimestamp).
//		Scan(ctx, &v)
...
func (slq *SystemLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemlog.Table, systemlog.Columns, sqlgraph.NewFieldSpec(systemlog.FieldID, field.TypeUint64))
	_spec.From = slq.sql
